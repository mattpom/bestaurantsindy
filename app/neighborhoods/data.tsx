...
export const neighborhoods:Neighborhood[]=[
  {id:"downtown",name:"Downtown",intro:"The Indianapolis essentials: historic dining rooms, serious steaks, and polished places built for a night that matters.",anchor:"St. Elmo Steak House",restaurants:[
    ...
    {name:"Fogo de Chão",label:"BRAZILIAN STEAKHOUSE",best:"Best for: tableside churrasco and a celebratory group dinner",note:"Fire-roasted cuts arrive continuously from gaucho chefs, backed by the Market Table and Brazilian side dishes in the historic Zipper Building.",price:"$$$$",href:"https://fogodechao.com/location/indianapolis/"},
    ...
    {name:"Shapiro’s Delicatessen",label:"INDY INSTITUTION",best:"Best for: a piled-high deli lunch with real Indianapolis history",note:"A downtown institution dating to 1905, known for made-to-order corned beef and pastrami sandwiches, rye bread, matzo ball soup, and a formidable dessert case.",price:"$$",href:"https://shapiros.com/"}
  ]},

...
export default function Home() {
  return <main>
    ...
    <section className="sayHome section">
      ...
      <a className="sayFeature" href="/say-it-dont-spray-it/indianapolis-needs-casual-seafood"><div><span>THE FIRST OPINION</span><h3>Indianapolis Has a Seafood Problem</h3><p>Where is the casual alternative to Red Lobster? And no, sushi does not answer the question.</p><b>Read Sean&apos;s take →</b></div></a>
    </section>
